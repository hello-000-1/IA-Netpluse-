...
handler.all = async function (m) {
  ...
  global.namechannel = '⏤͟͞㋡ 𝗙𝗨𝗖𝗞 𝗦𝗢𝗖𝗜𝗘𝗧𝗬 '
  global.namegrupo = ' 𝐈𝐚𝐍𝐞𝐭𝐩𝐥𝐮𝐬𝐞 ☘︎'
  global.namecomu = '𝗖𝗼𝗺𝘂𝗻𝗶𝗱𝗮𝗱 ⏤͟͞ 𝗙𝗨𝗖𝗞 𝗦𝗢𝗖𝗜𝗘𝗧𝗬 '
  global.listo = '⚔️ *Aquí tienes perra*'

  //Ids channel
  global.canalIdM = ["120363419782804545@newsletter", "120363419782804545@newsletter"]
  global.canalNombreM = ["⏤͟͞㋡ 𝗙𝗨𝗖𝗞 𝗦𝗢𝗖𝗜𝗘𝗧𝗬 ", "㋡ 𝗙𝗨𝗖𝗞 𝗦𝗢𝗖𝗜𝗘𝗧𝗬 "]
  ...
  global.rcanal = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: 100, newsletterName: channelRD.name }, externalAdReply: { showAdAttribution: true, title: "𝐈𝐚𝐍𝐞𝐭𝐩𝐥𝐮𝐬𝐞 ☘", body: "𝗘𝗹𝘃𝗶𝘀 SF", mediaUrl: null, description: null, previewType: "PHOTO", thumbnailUrl: icono, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false }, } }
